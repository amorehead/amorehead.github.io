...
As a Hopper Fellow at LBNL, I work with Drs. <a target='_blank' rel='noopener noreferrer' href='https://www.stat.berkeley.edu/~mmahoney/'>Michael Mahoney</a> (UC Berkeley, LBNL, ICSI) and <a target='_blank' rel='noopener noreferrer' href='https://sites.google.com/icsi.berkeley.edu/erichson'>Ben Erichson</a> (LBNL, ICSI), among many other researchers, on scientific machine learning and foundation models for science. For example, as part of these efforts, we introduced <a target='_blank' rel='noopener noreferrer' href='https://github.com/Zatom-AI/zatom'>Zatom-1</a>, the first fully open-source foundation model for 3D molecular and material science. If you are interested in contributing to such efforts, please feel free to reach out.
