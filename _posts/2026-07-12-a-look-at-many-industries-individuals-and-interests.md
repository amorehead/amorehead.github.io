...
tags: [Gaming, Culture, Curiosity, Science, Engineering, Psychology, Fantasy, Biography]
categories: Annotated-Readings
giscus_comments: true
thumbnail: assets/img/blog_post_images/07_2026/a-look-at-many-industries-individuals-and-interests.png
---

<div class="l-page">
  {% include figure.liquid path="assets/img/blog_post_images/07_2026/a-look-at-many-industries-individuals-and-interests.png" class="img-fluid rounded z-depth-1" zoomable=true %}
</div>
...
5. The Bell Jar
6. Nobody's Girl
7. To Gaze Upon Wicked Gods

## Behind the (gaming) scenes

<div class="l-body">
  {% include figure.liquid path="assets/img/blog_post_images/07_2026/blood-sweat-and-pixels.jpg" class="img-fluid rounded z-depth-1" zoomable=true %}
</div>

Ever wanted to know how video games are made (like, really transformed into those titles you can't stop playing or thinking about)? [Blood, Sweat, and Pixels](https://www.amazon.com/dp/0062651234?lv=shuf&channelId=500&plpRedirect=mhFallback) provides many stories of how iconic video game titles, such as Stardew Valley, came to be what they are today (i.e., a landmark in the industry). Passion surely fuels much of the industry, yet one also has to wonder whether chronic overwork (e.g., *unpaid* late night and weekend work hours) is simply a function of poor management common in game development firms or instead a necessary evil en route to a creative masterpiece? Time (and therapy) will probably provide a clearer answer as new generations of developers share their stories.

## Reconstructing skillful patterns

<div class="l-body">
  {% include figure.liquid path="assets/img/blog_post_images/07_2026/beyond-shame.jpg" class="img-fluid rounded z-depth-1" zoomable=true %}
</div>

Sexual shame is a ubiquitous carryover from many cultural traditions. To paraphrase the [wise words of Brené Brown](https://brenebrown.com/articles/2013/01/15/shame-v-guilt/), guilt can be adaptive and helpful to promote positive change in one's life, while shame (especially that which is based on the grounds of ostracization), in practice, is rarely skillful for enacting positive change. [Beyond Shame](https://matthiasroberts.com/beyondshame/) can help one map out the difference between guilt and shame from the perspective of sexual health, in particular for those from certain religious backgrounds. In doing so, it can help you develop a better understanding of yourself and your values, which is almost always an activity with a high return on investment.

## Wow, what a quaint lad

<div class="l-body">
  {% include figure.liquid path="assets/img/blog_post_images/07_2026/a-mind-at-play.jpg" class="img-fluid rounded z-depth-1" zoomable=true %}
</div>

Claude Shannon, after whom Anthropic's [Claude model family](https://claude.com/product/overview) is named, is known as the father of [Information Theory](https://en.wikipedia.org/wiki/Information_theory). Many biographies and films of other leading figures in the history of computing, such as Alan Turing, have been published to date, yet Shannon hasn't received as much attention until the last decade or so. With the publication of [A Mind at Play](https://en.wikipedia.org/wiki/A_Mind_at_Play), we now have a biographical window through which to peer into Shannon's life and upbringing, what made him tick (or more tellingly, what made him curious), and how he viewed the world. My impression after reading this biography is that Shannon, albeit far from a perfect human being (in terms of relationships and sociability), was an exceptionally talented and charming character, resolutely interested in exploring the world through both science and engineering (e.g., through both mathematics and robotics). Another takeaway of mine: we need more Shannons in this world.

## Feyman, you've done it again!

<div class="l-body">
  {% include figure.liquid path="assets/img/blog_post_images/07_2026/surely-youre-joking-mr-feynman.jpg" class="img-fluid rounded z-depth-1" zoomable=true %}
</div>

Like Shannon, Feynman was a curious character who cannot be easily encapsulated in a single description. He played a role in many instrumental discoveries in both science and engineering, and his interests varied widely (like many other historical polymaths). [Surely You're Joking, Mr. Feynman](https://en.wikipedia.org/wiki/Surely_You%27re_Joking,_Mr._Feynman!) is perhaps the best book to read for a glance into the witty world of Feynman, following him in his travels across America as well as internationally. You probably owe it to yourself to read this book at least once, so you'll know what all the hubbub of Feynman is about (but don't just stop there!).

## Mental health in a past era
